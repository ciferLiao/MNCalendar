...
public class MNCalendarVerticalConfig {
    ...
    private int mnCalendar_countMonth_offset = 12;
    //是否是单选
    private boolean issingine = false;
    //移动到最后
    private boolean moveToBottom = false;

    //是否有时间限制
    private boolean isTimeChoseLimit = false;
    //时间限制多少天
    ...
    public int getMnCalendar_countMonth_offset() {
        return mnCalendar_countMonth_offset;
    }

    public void setMnCalendar_countMonth_offset(int mnCalendar_countMonth_offset) {
        this.mnCalendar_countMonth_offset = mnCalendar_countMonth_offset;
    }

    public boolean isTimeChoseLimit() {
        return isTimeChoseLimit;
    }

    public void setTimeChoseLimit(boolean timeChoseLimit) {
        isTimeChoseLimit = timeChoseLimit;
    }
    ...
    public boolean isIssingine() {
        return issingine;
    }

    public void setIssingine(boolean issingine) {
        this.issingine = issingine;
    }
    ...
    public void setMoveToBottom(boolean moveToBottom) {
    ...
    public static class Builder {
        ...
        public Builder setMnCalendar_issingine(boolean singine) {
            mnCalendarConfig.setIssingine(singine);
            return this;
        }
        ...
        public Builder setMnCalendar_moveToBottom(boolean moveToBottom) {
            mnCalendarConfig.setMoveToBottom(moveToBottom);
            return this;
        }
        public Builder setTimeChoseLimit(boolean timeChooseLimit) {
            mnCalendarConfig.setTimeChoseLimit(timeChooseLimit);
            return this;
        }
        public Builder setMonthOffset(int offset) {
            mnCalendarConfig.setMnCalendar_countMonth_offset(offset);
            return this;
        }

        public Builder setPeriodTime(int periodTime) {
            mnCalendarConfig.setPeriodDays(periodTime);
            return this;
        }
